...
TEST(TestTrajectory, LinearTrajectoryTest) {
    ...
    std::pair<coord_t, coord_t> start_coordinates_0 = {0.0, 0.0};
    ...
    std::pair<coord_t, coord_t> start_coordinates_1 = {1.0, 1.0};
    ...
    std::pair<coord_t, coord_t> start_coordinates_2 = {-1.0, -2.0};
...
TEST(TestTrajectory, ParabolaTrajectoryTest) {
    ...
    std::pair<coord_t, coord_t> start_coordinates_1 = {2.0, 3.0};
    ...
    std::pair<coord_t, coord_t> start_coordinates_2 = {-1.0, -1.0};
...
TEST(TestTrajectory, SineWaveTrajectoryTest) {
    ...
    std::pair<coord_t, coord_t> start_coordinates_2 = {-2.0, 2.0};
